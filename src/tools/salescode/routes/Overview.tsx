 ...
 * result" depending on what the owner has done.
 */
export function SalesCodeOverview() {
  ...
  return (
    <div className="app-content py-12 flex flex-col gap-6">
      ...
      {isSubmitted ? (
        <div className="rounded-md border border-border bg-surface px-4 py-3 flex items-center justify-between gap-4 max-w-xl">
